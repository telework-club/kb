...
![由我们的 bot 同步的 Github Issue](./tc.01.01.001/3.jpeg)

![每天下班之前自动生成的当天动态报告](./tc.01.01.001/4.jpeg)

![每周周会之前自动生成的 Weekly Report](./tc.01.01.001/5.jpeg)

![提前根据模版生成出来的个人周报](./tc.01.01.001/6.jpeg)

![提醒大家准备周报的企业微信机器人](./tc.01.01.001/7.jpeg)

![SRE 机器人自动 Merge PR 并 Cherry-pick 到 Release 分支](./tc.01.01.001/8.jpeg)
